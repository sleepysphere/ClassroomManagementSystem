...
public class RoomsPanel extends JPanel {
     ...
     * @param roomRepository Repository for managing room data
     */
    public RoomsPanel(RoomRepository roomRepository) {
     ...
     * TODO: Need to call roomRepository.delete(id) to remove from database
     */
     ...
     * Reloads entire list of rooms from database via repository
